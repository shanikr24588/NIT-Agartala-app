package com.shani.nita.userScreens.Civil
...
@Composable
fun Civil(navController: NavController){

    Surface(color = colorResource(id = R.color.surfaceColor)) {
        val branch = "CE"
        Scaffold(
            topBar = {
                TopAppBar(title = { Text(text = "Civil Department",
                ...
                Column(modifier = Modifier.padding(padding)){
                    Row(modifier = Modifier
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable { navController.navigate("civil_faculty") },
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable { navController.navigate("civil_notes_semester/${branch}") },
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable { navController.navigate("civil_pyq_semester/${branch}") },
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable { navController.navigate("civil_pindocs_semester/${branch}") },
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
