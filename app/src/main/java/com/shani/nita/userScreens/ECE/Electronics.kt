package com.shani.nita.userScreens.ECE
            ...
            Column(modifier = Modifier.padding(padding)){
                Row(modifier = Modifier
                    ...
                    Card(modifier = Modifier
                        .height(70.dp)
                        .width(70.dp)
                        .clickable { navController.navigate("ece_semester_screen/${branch}") },
                        shape = RoundedCornerShape(8.dp),
                        elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                        colors = CardDefaults.cardColors(containerColor = Color.White)){
                        Column(verticalArrangement = Arrangement.SpaceEvenly,
                    ...
                    Card(modifier = Modifier
                        .height(70.dp)
                        .width(70.dp)
                        .clickable { navController.navigate("ece_pyq_semester/${branch}") },
                        shape = RoundedCornerShape(8.dp),
                        elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                        colors = CardDefaults.cardColors(containerColor = Color.White)){
                        Column(verticalArrangement = Arrangement.SpaceEvenly,
                    ...
                    Card(modifier = Modifier
                        .height(70.dp)
                        .width(70.dp)
                        .clickable { navController.navigate("ece_pindocs_semester/${branch}") },
                        shape = RoundedCornerShape(8.dp),
                        elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                        colors = CardDefaults.cardColors(containerColor = Color.White)){
                        Column(verticalArrangement = Arrangement.SpaceEvenly,
