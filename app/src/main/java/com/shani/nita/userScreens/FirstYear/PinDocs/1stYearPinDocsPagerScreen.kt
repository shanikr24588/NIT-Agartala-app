package com.shani.nita.userScreens.FirstYear.PinDocs
...
@Composable
fun firstYearPinDocsPagerScreen(navController: NavController, branch: String) {
    ...
    val pindocsMap by branchViewModel.pindocsMap.observeAsState(mutableMapOf())
    ...
    LaunchedEffect(semesterList) {
        if (semesterList.isNotEmpty()) {
            ...
            branchViewModel.getPinDocs(branch, initialSemester)
        }
    }
    ...
    Column(
        ...
        HorizontalPager(
            ...
            val pindocs = pindocsMap[semester] ?: emptyList()
