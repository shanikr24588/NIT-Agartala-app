package com.shani.nita.userScreens.ME
...
@Composable
fun Mechanical(navController: NavController){
    ...
    Surface(color = colorResource(id = R.color.surfaceColor)) {
        ...
        Scaffold(
            topBar = {
                TopAppBar(title = { Text(text = "Mechanical Department",
                ...
                Column(modifier = Modifier.padding(padding)){
                    Row(modifier = Modifier
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable { navController.navigate("mech_faculty") },
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable {navController.navigate("mech_notes_semester/${branch}")},
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable {navController.navigate("mech_pyq_semester/${branch}")},
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
                        ...
                        Card(modifier = Modifier
                            .height(70.dp)
                            .width(70.dp)
                            .clickable {navController.navigate("mech_pindocs_semester/${branch}")},
                            shape = RoundedCornerShape(8.dp),
                            elevation = CardDefaults.cardElevation(defaultElevation = 6.dp),
                            colors = CardDefaults.cardColors(containerColor = Color.White)){
                            Column(verticalArrangement = Arrangement.SpaceEvenly,
