package com.shani.nita.userScreens.FirstYear.PYQ
...
@Composable
fun firstYearPYQPagerScreen(navController: NavController, branch: String) {
    ...
    val pyqMap by branchViewModel.pyqMap.observeAsState(mutableMapOf())
    ...
    LaunchedEffect(semesterList) {
        if (semesterList.isNotEmpty()) {
            ...
            branchViewModel.getPyq(branch, initialSemester)
        }
    }
    ...
    Column(
        ...
        HorizontalPager(
            ...
            val notes = pyqMap[semester] ?: emptyList()
