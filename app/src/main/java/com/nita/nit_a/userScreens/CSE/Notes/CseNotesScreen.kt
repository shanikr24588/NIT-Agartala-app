package com.nita.nit_a.userScreens.CSE.Notes
...
import com.nita.nit_a.userScreens.Facilities.Notice.NoticeItemView

@OptIn(ExperimentalMaterial3Api::class)
@Composable

fun CseNotesScreen(navController: NavController, branch:String, semester:String){
    ...
    val notesList by branchViewModel.notesList.observeAsState(emptyList())
